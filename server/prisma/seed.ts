...
async function main() {
    const products = [
        ...
        },
        {
            ...
            images: JSON.stringify(['/assets/products/chunchoqin.jpg']),
            collection: 'Classic',
        ...
        },
        {
            ...
            images: JSON.stringify(['/assets/products/white_gold.png']),
            collection: 'Berries',
        ...
        },
        {
            ...
            images: JSON.stringify(['/assets/products/gifts_of_nature_colombia.png']),
            collection: 'Gifts',
